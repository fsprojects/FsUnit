...
[<assembly: AssemblyVersionAttribute("7.1.1.0")>]
[<assembly: AssemblyFileVersionAttribute("7.1.1.0")>]
do ()
...
module internal AssemblyVersionInformation =
    ...
    let [<Literal>] AssemblyVersion = "7.1.1.0"
    let [<Literal>] AssemblyFileVersion = "7.1.1.0"
